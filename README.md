...
| SIG Sauer Tango-MSR MRAD Milling 2.0 (MRAD, FFP) | MIL | FFP (all mags) | MRAD tree | Numbered H/V stadia (1 MIL minor / 2 MIL major, labeled 2–14), thick posts at ±14 MIL; dot-grid holdover tree below center rows 2→14 MIL. Real reticle is a fine continuous mil grid (0.2 MIL ticks); rendered here as the app's standard dot-grid tree — subtension labels are accurate, background pattern is an approximation. Source: TANGO-MSR Operator's Manual p.28 |
| SIG Sauer Tango-MSR MOA Milling 2.0 (MOA, FFP) | MOA | FFP (all mags) | MOA tree | Numbered H/V stadia (1 MOA minor / 4 MOA major, labeled 4–28), thick posts at ±30 MOA; dot-grid tree below center rows 4→32 MOA at 2 MOA dot spacing. Source: TANGO-MSR Operator's Manual p.30 |
