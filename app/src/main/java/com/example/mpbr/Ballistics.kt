...
object Ballistics {
    ...
    val PRESETS: List<AmmoPreset> = listOf(
        ...
        AmmoPreset("223 Rem 55gr FMJ",            3215.0, 0.202,  55.0, 2.6, 6.0, caliber = "223 Rem"),
        AmmoPreset("223 Rem 62gr FMJ BT",         3100.0, 0.265,  62.0, 2.6, 6.0, caliber = "223 Rem"),
        AmmoPreset("223 Rem 77gr SMK",            2700.0, 0.185,  77.0, 2.6, 6.0, DragModel.G7, caliber = "223 Rem"),
        AmmoPreset("223 Rem 55gr HP",             3240.0, 0.235,  55.0, 2.6, 6.0, caliber = "223 Rem"),
        AmmoPreset("223 Rem 69gr SMK",            2950.0, 0.191,  69.0, 2.6, 6.0, DragModel.G7, caliber = "223 Rem"),
        AmmoPreset("223 Rem 75gr BTHP",           2790.0, 0.220,  75.0, 2.6, 6.0, DragModel.G7, caliber = "223 Rem"),
        AmmoPreset("223 Rem 77gr HPBT (SBR)",    2750.0, 0.372,  77.0, 1.5, 6.0, caliber = "223 Rem"),
        ...
        AmmoPreset("M193 (5.56×45)",              3250.0, 0.243,  55.0, 2.6, 6.0, caliber = "5.56×45"),
        AmmoPreset("M855 (5.56×45)",              3025.0, 0.304,  62.0, 2.6, 6.0, caliber = "5.56×45"),
        AmmoPreset("M855A1 EPR (5.56×45)",        3150.0, 0.152,  62.0, 2.6, 6.0, DragModel.G7, caliber = "5.56×45"),
        AmmoPreset("Mk262 Mod1 77gr OTM",         2848.0, 0.185,  77.0, 2.6, 6.0, DragModel.G7, caliber = "5.56×45"),
        // .243/6mm
        ...
        AmmoPreset("M80 (7.62×51 NATO)",          2750.0, 0.398, 147.0, 2.6, 6.0, caliber = "308 Win"),
        AmmoPreset("308 Win 125gr SST (SBR)",     3250.0, 0.305, 125.0, 1.5, 6.0, caliber = "308 Win"),
        AmmoPreset("308 Win 150gr FMJ",           2820.0, 0.409, 150.0, 2.6, 6.0, caliber = "308 Win"),
        AmmoPreset("308 Win 155gr Palma",         2940.0, 0.219, 155.0, 2.6, 6.0, DragModel.G7, caliber = "308 Win"),
        AmmoPreset("308 Win 165gr BT",            2700.0, 0.450, 165.0, 2.6, 6.0, caliber = "308 Win"),
        AmmoPreset("308 Win 168gr SMK",           2650.0, 0.224, 168.0, 2.6, 6.0, DragModel.G7, caliber = "308 Win"),
        AmmoPreset("308 Win 175gr SMK",           2600.0, 0.250, 175.0, 2.6, 6.0, DragModel.G7, caliber = "308 Win"),
        AmmoPreset("308 Win 180gr SP",            2600.0, 0.383, 180.0, 2.6, 6.0, caliber = "308 Win"),
        AmmoPreset("308 Win 190gr Fusion (subsonic)", 1000.0, 0.494, 190.0, 2.6, 6.0, caliber = "308 Win"),
        AmmoPreset("308 Win 200gr FMJBT (subsonic)",  1066.0, 0.235, 200.0, 2.6, 6.0, DragModel.G7, caliber = "308 Win"),
        AmmoPreset("308 Win 205gr HP (subsonic)",     1000.0, 0.480, 205.0, 2.6, 6.0, caliber = "308 Win"),
        // .338
