...
| Firefield RapidStrike CR1 1-10x24 (MOA, SFP) | MOA | SFP (10×) | Circle BDC | 5.73 MOA circle (= 18" IPSC target at 300 yd) + 1.34 MOA center dot (0–200 yd); 300-yd holdover at circle exit; hashes at 400/500/600 yd (depths estimated from .223 55gr FMJ ballistics at 100-yd zero). Source: FF13075 user manual pp.14–15 |
