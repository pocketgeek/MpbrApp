...
| EOTech VUDU MR5 (MRAD, FFP) | MIL | FFP (all mags) | MRAD tree | Numbered horizontal stadia with 0.5 MRAD ticks; 1 MRAD speed ring; dot-grid Christmas tree rows 1–7 MRAD |
...
| SIG Sauer Tango-MSR MRAD Milling 2.0 (MRAD, FFP) | MIL | FFP (all mags) | SIG MRAD Milling | Fine continuous grid: 0.2 MIL minor ticks, numbered every 2 MIL out to ±14; short 4 MIL top post; full elevation/windage mesh below center to 14 MIL (major lines every 2 MIL); thick outer posts beyond ±14 MIL. Dedicated drawing style — matches the manual diagram's grid, not a dot-grid tree. Source: TANGO-MSR Operator's Manual pp.28–29 |
| SIG Sauer Tango-MSR MOA Milling 2.0 (MOA, FFP) | MOA | FFP (all mags) | SIG MOA Milling | Same concept as the MRAD version, scaled for MOA: 0.5 MOA minor ticks, numbered every 4 MOA out to ±30; short 8 MOA top post; full mesh below center to 30 MOA; thick outer posts beyond ±30 MOA. Source: TANGO-MSR Operator's Manual pp.30–31 |
