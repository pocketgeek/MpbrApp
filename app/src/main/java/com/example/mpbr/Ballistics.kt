...
object Ballistics {
    ...
    val PRESETS: List<AmmoPreset> = listOf(
        // ── Rifle ─────────────────────────────────────────────────────────────────
        // .22 cal
        AmmoPreset("5.45×39 7N6 53gr",            2900.0, 0.351,  53.0, 2.6, 6.0),
        AmmoPreset("5.45×39 7N10 56gr",           2900.0, 0.351,  56.0, 2.6, 6.0),
        AmmoPreset("5.45×39 60gr FMJ (Tula)",     2936.0, 0.329,  60.0, 2.6, 6.0),
        AmmoPreset("5.45×39 60gr V-MAX",          2810.0, 0.285,  60.0, 2.6, 6.0),
        // .204 Ruger
        AmmoPreset("204 Ruger 32gr V-MAX",        4225.0, 0.210,  32.0, 2.6, 6.0),
        AmmoPreset("204 Ruger 40gr V-MAX",        3900.0, 0.275,  40.0, 2.6, 6.0),
        AmmoPreset("204 Ruger 45gr SP",           3625.0, 0.225,  45.0, 2.6, 6.0),
        ...
        AmmoPreset("223 Rem 77gr HPBT (SBR)",    2750.0, 0.372,  77.0, 1.5, 6.0),
        ...
        AmmoPreset("M193 (5.56×45)",              3250.0, 0.243,  55.0, 2.6, 6.0),
        AmmoPreset("M855 (5.56×45)",              3025.0, 0.304,  62.0, 2.6, 6.0),
        AmmoPreset("M855A1 EPR (5.56×45)",        3150.0, 0.152,  62.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("Mk262 Mod1 77gr OTM",         2848.0, 0.185,  77.0, 2.6, 6.0, DragModel.G7),
        // .243/6mm
        AmmoPreset("243 Win 55gr BT",             3850.0, 0.230,  55.0, 2.6, 6.0),
        AmmoPreset("243 Win 80gr SP",             3330.0, 0.325,  80.0, 2.6, 6.0),
        AmmoPreset("243 Win 95gr BT",             3100.0, 0.400,  95.0, 2.6, 6.0),
        AmmoPreset("243 Win 100gr PP",            2960.0, 0.380, 100.0, 2.6, 6.0),
        AmmoPreset("6mm ARC 103gr ELD-X",         2800.0, 0.258, 103.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("6mm ARC 105gr BTHP",          2750.0, 0.253, 105.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("6mm ARC 105gr FMJ Frontier",  2700.0, 0.530, 105.0, 2.6, 6.0),
        AmmoPreset("6mm ARC 106gr TAP ELD-M",       2610.0, 0.580, 106.0, 2.6, 6.0),
        AmmoPreset("6mm ARC 108gr ELD-M",         2750.0, 0.270, 108.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("6mm CM 103gr ELD-X",          3050.0, 0.258, 103.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("6mm CM 108gr ELD-M",          2960.0, 0.270, 108.0, 2.6, 6.0, DragModel.G7),
        // 6mm Rem
        AmmoPreset("6mm Rem 80gr SP",             3470.0, 0.340,  80.0, 2.6, 6.0),
        AmmoPreset("6mm Rem 100gr PSP",           3100.0, 0.414, 100.0, 2.6, 6.0),
        AmmoPreset("6mm Rem 105gr BT",            3100.0, 0.430, 105.0, 2.6, 6.0),
        // .257/25 cal
        // .257 Roberts
        AmmoPreset("257 Roberts 100gr SP",        2900.0, 0.360, 100.0, 2.6, 6.0),
        AmmoPreset("257 Roberts 117gr SP",        2780.0, 0.370, 117.0, 2.6, 6.0),
        AmmoPreset("257 Roberts +P 120gr",        2980.0, 0.391, 120.0, 2.6, 6.0),
        AmmoPreset("25-06 Rem 87gr V-MAX",        3440.0, 0.400,  87.0, 2.6, 6.0),
        AmmoPreset("25-06 Rem 100gr BT",          3210.0, 0.418, 100.0, 2.6, 6.0),
        AmmoPreset("25-06 Rem 117gr SST",         2990.0, 0.370, 117.0, 2.6, 6.0),
        // .260/6.5mm
        AmmoPreset("6.5 Grendel 90gr TNT HP",     2880.0, 0.270,  90.0, 2.6, 6.0),
        AmmoPreset("6.5 Grendel 123gr ELD-M",     2580.0, 0.263, 123.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("6.5 Grendel 130gr Hybrid",    2500.0, 0.284, 130.0, 2.6, 6.0, DragModel.G7),
        // 6.5×55 Swedish
        AmmoPreset("6.5×55 120gr SP",             2780.0, 0.416, 120.0, 2.6, 6.0),
        AmmoPreset("6.5×55 140gr BTSP",           2625.0, 0.435, 140.0, 2.6, 6.0),
        AmmoPreset("6.5×55 156gr RN",             2430.0, 0.375, 156.0, 2.6, 6.0),
        AmmoPreset("260 Rem 120gr AccuTip",       2890.0, 0.480, 120.0, 2.6, 6.0),
        AmmoPreset("260 Rem 130gr ELD-M",         2875.0, 0.554, 130.0, 2.6, 6.0),
        AmmoPreset("260 Rem 140gr Core-Lokt",     2750.0, 0.435, 140.0, 2.6, 6.0),
        AmmoPreset("6.5 CM 120gr ELD-M",          2910.0, 0.245, 120.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("6.5 CM 129gr SST",            2810.0, 0.485, 129.0, 2.6, 6.0),
        AmmoPreset("6.5 CM 130gr Berger Hybrid",  2875.0, 0.287, 130.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("6.5 CM 140gr ELD-M",          2710.0, 0.326, 140.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("6.5 CM 143gr ELD-X",          2700.0, 0.315, 143.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("6.5 CM 147gr ELD-M",          2695.0, 0.351, 147.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("6.5 PRC 143gr ELD-X",         2960.0, 0.315, 143.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("6.5 PRC 147gr ELD-M",         2910.0, 0.352, 147.0, 2.6, 6.0, DragModel.G7),
        // .270/6.8mm
        AmmoPreset("270 Win 130gr BT",            3060.0, 0.337, 130.0, 2.6, 6.0),
        AmmoPreset("270 Win 140gr AccuBond",      3100.0, 0.206, 140.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("270 Win 150gr SP",            2800.0, 0.205, 150.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("270 WSM 130gr BT",            3300.0, 0.433, 130.0, 2.6, 6.0),
        AmmoPreset("270 WSM 140gr AccuBond",      3100.0, 0.496, 140.0, 2.6, 6.0),
        AmmoPreset("270 WSM 150gr Silvertip",     3120.0, 0.496, 150.0, 2.6, 6.0),
        AmmoPreset("6.8 Western 165gr AccuBond LR", 2970.0, 0.344, 165.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("6.8 Western 170gr BST",       2920.0, 0.327, 170.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("6.8 Western 175gr SGK",       2835.0, 0.361, 175.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("6.8 SPC 100gr GMX",           2700.0, 0.138, 100.0, 2.6, 6.0, DragModel.G7),
        ...
        // 7×57 Mauser
        AmmoPreset("7×57 Mauser 140gr SP",        2660.0, 0.330, 140.0, 2.6, 6.0),
        AmmoPreset("7×57 Mauser 154gr SP",        2690.0, 0.356, 154.0, 2.6, 6.0),
        AmmoPreset("7×57 Mauser 175gr PP",        2490.0, 0.347, 175.0, 2.6, 6.0),
        AmmoPreset("7mm-08 139gr SST",            2950.0, 0.486, 139.0, 2.6, 6.0),
        AmmoPreset("7mm-08 140gr BT",             2825.0, 0.319, 140.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("7mm-08 140gr Fusion",         2850.0, 0.390, 140.0, 2.6, 6.0),
        AmmoPreset("7mm-08 150gr JSP",            2650.0, 0.408, 150.0, 2.6, 6.0),
        // .308/30-cal
        // 7.62×54R
        AmmoPreset("7.62×54R 148gr FMJ 7N1",     2838.0, 0.390, 148.0, 2.6, 6.0),
        AmmoPreset("7.62×54R 150gr SP",           2900.0, 0.398, 150.0, 2.6, 6.0),
        AmmoPreset("7.62×54R 174gr FMJ",          2600.0, 0.490, 174.0, 2.6, 6.0),
        AmmoPreset("7.62×39 122gr FMJ",           2418.0, 0.257, 122.0, 2.6, 6.0),
        AmmoPreset("7.62×39 123gr HP",            2350.0, 0.270, 123.0, 2.6, 6.0),
        AmmoPreset("30 Carbine 110gr FMJ",        1990.0, 0.166, 110.0, 2.6, 6.0),
        AmmoPreset("30 Carbine 110gr FTX",        2000.0, 0.166, 110.0, 2.6, 6.0),
        AmmoPreset("30 Carbine 125gr HC",         1950.0, 0.126, 125.0, 2.6, 6.0),
        ...
        AmmoPreset("30-06 180gr SP",              2700.0, 0.205, 180.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("30-06 220gr RN",              2410.0, 0.300, 220.0, 2.6, 6.0),
        AmmoPreset("300 BLK 110gr V-MAX",         2375.0, 0.290, 110.0, 2.6, 6.0),
        AmmoPreset("300 BLK 125gr PPU",           2329.0, 0.325, 125.0, 2.6, 6.0),
        AmmoPreset("300 BLK 125gr SST (SBR)",    2200.0, 0.305, 125.0, 1.5, 6.0),
        AmmoPreset("300 BLK 147gr FMJ",           1920.0, 0.398, 147.0, 2.6, 6.0),
        AmmoPreset("300 BLK 200gr (subsonic)",    1050.0, 0.540, 200.0, 2.6, 6.0),
        AmmoPreset("300 BLK 220gr (subsonic)",    1045.0, 0.608, 220.0, 2.6, 6.0),
        AmmoPreset("300 BLK 220gr BT sub (SBR)", 1075.0, 0.472, 220.0, 1.5, 6.0),
        // .338/8.6mm BLK
        AmmoPreset("8.6 BLK 135gr CX",             2650.0, 0.193, 135.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("8.6 BLK 210gr Barnes TSX",      2000.0, 0.430, 210.0, 2.6, 6.0),
        AmmoPreset("8.6 BLK 250gr Sub-X (subsonic)",1050.0, 0.540, 250.0, 2.6, 6.0),
        AmmoPreset("8.6 BLK 300gr SMK (subsonic)",  1050.0, 0.750, 300.0, 2.6, 6.0),
        AmmoPreset("300 PRC 212gr ELD-X",         2860.0, 0.334, 212.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("300 PRC 225gr ELD-M",         2810.0, 0.391, 225.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("300 PRC 245gr Elite Hunter",  2720.0, 0.413, 245.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("300 PRC 250gr A-Tip",         2800.0, 0.442, 250.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("300 Win Mag 150gr PP",        3290.0, 0.310, 150.0, 2.6, 6.0),
        AmmoPreset("300 Win Mag 168gr SMK",       3000.0, 0.235, 168.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("300 Win Mag 180gr AccuBond",  2950.0, 0.250, 180.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("300 Win Mag 190gr SMK",       2950.0, 0.290, 190.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("300 Win Mag 200gr Partition", 2930.0, 0.245, 200.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("300 WSM 150gr BT",            3300.0, 0.435, 150.0, 2.6, 6.0),
        AmmoPreset("300 WSM 180gr AccuBond",      2970.0, 0.250, 180.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("300 WSM 180gr Power Point",   2970.0, 0.474, 180.0, 2.6, 6.0),
        // .303 British
        AmmoPreset("303 British 150gr FMJ",       2700.0, 0.330, 150.0, 2.6, 6.0),
        AmmoPreset("303 British 174gr FMJ",       2540.0, 0.384, 174.0, 2.6, 6.0),
        AmmoPreset("303 British 180gr SP",        2460.0, 0.396, 180.0, 2.6, 6.0),
        AmmoPreset("M80 (7.62×51 NATO)",          2750.0, 0.398, 147.0, 2.6, 6.0),
        AmmoPreset("308 Win 125gr SST (SBR)",     3250.0, 0.305, 125.0, 1.5, 6.0),
        ...
        AmmoPreset("338 Win Mag 250gr Partition", 2650.0, 0.473, 250.0, 2.6, 6.0),
        AmmoPreset("338 Lapua 250gr SMK",         2950.0, 0.340, 250.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("338 Lapua 285gr ELD-M",       2900.0, 0.405, 285.0, 2.6, 6.0, DragModel.G7),
        AmmoPreset("338 Lapua 300gr SMK",         2650.0, 0.390, 300.0, 2.6, 6.0, DragModel.G7),
        // .375
        AmmoPreset("375 H&H 250gr BT",            2900.0, 0.385, 250.0, 2.6, 6.0),
        ...
        AmmoPreset("458 SOCOM 300gr BT",          1900.0, 0.250, 300.0, 2.6, 6.0),
        AmmoPreset("458 SOCOM 325gr FTX",         1800.0, 0.240, 325.0, 2.6, 6.0),
        AmmoPreset("458 SOCOM 350gr FMJ",         1650.0, 0.200, 350.0, 2.6, 6.0),
        // .50 Beowulf
        AmmoPreset("50 Beowulf 300gr GD JHP",     1870.0, 0.185, 300.0, 2.6, 6.0),
        AmmoPreset("50 Beowulf 325gr JHP",        1800.0, 0.178, 325.0, 2.6, 6.0),
        AmmoPreset("50 Beowulf 400gr JFP",        1800.0, 0.193, 400.0, 2.6, 6.0),
        // .50 BMG
        ...
        // ── Rimfire ───────────────────────────────────────────────────────────────
        // .17 HMR
        AmmoPreset("17 HMR 17gr A17",             2650.0, 0.128,  17.0, 2.6, 2.0, category = AmmoCategory.RIMFIRE),
        AmmoPreset("17 HMR 17gr TNT HP",          2550.0, 0.126,  17.0, 2.6, 2.0, category = AmmoCategory.RIMFIRE),
        AmmoPreset("17 HMR 17gr V-MAX",           2550.0, 0.128,  17.0, 2.6, 2.0, category = AmmoCategory.RIMFIRE),
        AmmoPreset("17 HMR 20gr XTP",             2375.0, 0.125,  20.0, 2.6, 2.0, category = AmmoCategory.RIMFIRE),
        // .17 WSM
        ...
        AmmoPreset("22 WMR 40gr JHP Maxi-Mag",    1875.0, 0.114,  40.0, 2.6, 2.0, category = AmmoCategory.RIMFIRE),
        AmmoPreset("22 WMR 40gr JHP Super-X",     1910.0, 0.116,  40.0, 2.6, 2.0, category = AmmoCategory.RIMFIRE),
        AmmoPreset("22 WMR 45gr JHP Super-X",     1550.0, 0.140,  45.0, 2.6, 2.0, category = AmmoCategory.RIMFIRE),
        // ── Pistol ────────────────────────────────────────────────────────────────
        // 5.7×28mm
        ...
        // .380 ACP
        AmmoPreset("380 ACP 85gr FTX Critical Def", 1000.0, 0.097, 85.0, 0.7, 4.0, category = AmmoCategory.PISTOL),
        ...
        AmmoPreset("9mm 115gr +P",        1300.0, 0.150, 115.0, 0.7, 4.0, category = AmmoCategory.PISTOL),
        ...
        AmmoPreset("9mm 124gr Critical Def", 1110.0, 0.134, 124.0, 0.7, 4.0, category = AmmoCategory.PISTOL),
        ...
        // .40/10mm
        AmmoPreset("40 S&W 155gr JHP",       1205.0, 0.142, 155.0, 0.7, 4.0, category = AmmoCategory.PISTOL),
        ...
        AmmoPreset("44 Mag 240gr JSP",          1180.0, 0.185, 240.0, 0.7, 4.0, category = AmmoCategory.PISTOL),
        ...
        // .45
        AmmoPreset("45 ACP 185gr FMJ",        1000.0, 0.130, 185.0, 0.7, 4.0, category = AmmoCategory.PISTOL),
        ...
        AmmoPreset("12ga Sabot 385gr AccuTip",        1850.0, 0.200, 385.0, 2.6, 8.0, category = AmmoCategory.SHOTGUN),
