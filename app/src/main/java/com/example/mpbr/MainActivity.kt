            ...
            Card(modifier = Modifier.fillMaxWidth()) {
                Column(
                    ...
                    if (metricMode) {
                        ...
                        ResultRow("Minimum Point Blank Range", "%.0f m".format(r.minPbrYards * 0.9144))
                        if (r.energyAtMinPbrFtLb > 0.0)
                            ResultRow("Energy at Min PBR", "%.0f J".format(r.energyAtMinPbrFtLb * 1.35582))
                        ...
                        ResultRow("Minimum Point Blank Range", "%.0f yd".format(r.minPbrYards))
                        if (r.energyAtMinPbrFtLb > 0.0)
                            ResultRow("Energy at Min PBR", "%.0f ft·lb".format(r.energyAtMinPbrFtLb))
