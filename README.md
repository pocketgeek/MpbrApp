...
| <img src="screenshots/reticles/25_Vortex_Dead_Hold_BDC_MOA_SFP.png" width="90"> Vortex Dead-Hold BDC (MOA, SFP) | MOA | SFP (max mag) | BDC | Holdover hashmarks: 1.5 / 4.5 / 7.5 MOA; windage ±2 / ±4 / ±6 MOA; thick outer posts begin at 11 MOA (the post's top edge, not a 4th hashmark — corrected from an earlier version of this preset). Source: Vortex Dead-Hold BDC MOA reticle manual |
