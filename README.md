...
|---|---|---|---|---|
| Vortex Strike Eagle AR-BDC3 (MOA, SFP) | MOA | SFP (8×) | AR-BDC3 | 16.625 MOA broken circle (gaps at cardinals) + 1 MOA center dot; holdover post 2.4/5.6/9.5/14.6 MOA (300–600 yd for 5.56) |
